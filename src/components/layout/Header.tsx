...
export default function Header() {
  return (
    <div className="flex fixed top-0 left-0 mb-80 px-10 w-full items-end h-[78px] justify-center pb-[14px] bg-[#101010] border-b-[1px]  border-b-gray-500/20">
      <div className="flex  items-center max-w-[1280px] justify-between  w-full h-fit ">
        ...
        <div className="overflow-hidden ml-10  max-h-[36px] ">
          <img
            src="/insta.png
            "
            className="w-[125px]"
